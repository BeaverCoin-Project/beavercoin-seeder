...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "BeaverCoin-seeder\n"
...
static const string mainnet_seeds[] = {"dnsseed.beavercoin.org", ""};
static const string testnet_seeds[] = {"testnet-seed.beavercoin.org", ""};
